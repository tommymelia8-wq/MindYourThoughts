...
public partial class @PlayerInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                {
                    ""name"": ""LeftFlipper"",
                    ""type"": ""Button"",
                    ""id"": ""b1f070e0-dcfe-453d-a74e-41d284b8dad3"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": ""Press"",
                ...
                },
                {
                    ""name"": ""RightFlipper"",
                    ""type"": ""Button"",
                    ""id"": ""24e9c8c3-f800-492d-8283-4da6ead4b814"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": ""Press"",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""c6cab271-c048-414d-8de3-301e6989d6e8"",
                    ""path"": ""<Keyboard>/#(A)"",
                    ""interactions"": ""Press"",
                    ""processors"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""054ebb21-5a4e-435c-85f3-6d3face60822"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": ""Press"",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse;Touch"",
        ...
        {
            ""name"": ""FlipControl"",
            ""id"": ""4834fa55-ffbe-4f91-8f21-1ba7a8550420"",
            ""actions"": [
                {
                    ""name"": ""New action"",
                    ""type"": ""Button"",
                    ""id"": ""658c242a-3a67-40ce-970a-2e81b0ec7af2"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""79705aa3-ec16-4a70-8c35-6518e8020aae"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        // FlipControl
        m_FlipControl = asset.FindActionMap("FlipControl", throwIfNotFound: true);
        m_FlipControl_Newaction = m_FlipControl.FindAction("New action", throwIfNotFound: true);
    }
    ...
    ~@PlayerInput()
    {
        ...
        UnityEngine.Debug.Assert(!m_FlipControl.enabled, "This will cause a leak and performance issues, PlayerInput.FlipControl.Disable() has not been called.");
    }
    ...
    // FlipControl
    private readonly InputActionMap m_FlipControl;
    private List<IFlipControlActions> m_FlipControlActionsCallbackInterfaces = new List<IFlipControlActions>();
    private readonly InputAction m_FlipControl_Newaction;
    /// <summary>
    /// Provides access to input actions defined in input action map "FlipControl".
    /// </summary>
    public struct FlipControlActions
    {
        private @PlayerInput m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public FlipControlActions(@PlayerInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "FlipControl/Newaction".
        /// </summary>
        public InputAction @Newaction => m_Wrapper.m_FlipControl_Newaction;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_FlipControl; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="FlipControlActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(FlipControlActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="FlipControlActions" />
        public void AddCallbacks(IFlipControlActions instance)
        {
            if (instance == null || m_Wrapper.m_FlipControlActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_FlipControlActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="FlipControlActions" />
        private void UnregisterCallbacks(IFlipControlActions instance)
        {
            @Newaction.started -= instance.OnNewaction;
            @Newaction.performed -= instance.OnNewaction;
            @Newaction.canceled -= instance.OnNewaction;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="FlipControlActions.UnregisterCallbacks(IFlipControlActions)" />.
        /// </summary>
        /// <seealso cref="FlipControlActions.UnregisterCallbacks(IFlipControlActions)" />
        public void RemoveCallbacks(IFlipControlActions instance)
        {
            if (m_Wrapper.m_FlipControlActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="FlipControlActions.AddCallbacks(IFlipControlActions)" />
        /// <seealso cref="FlipControlActions.RemoveCallbacks(IFlipControlActions)" />
        /// <seealso cref="FlipControlActions.UnregisterCallbacks(IFlipControlActions)" />
        public void SetCallbacks(IFlipControlActions instance)
        {
            foreach (var item in m_Wrapper.m_FlipControlActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_FlipControlActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="FlipControlActions" /> instance referencing this action map.
    /// </summary>
    public FlipControlActions @FlipControl => new FlipControlActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "FlipControl" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="FlipControlActions.AddCallbacks(IFlipControlActions)" />
    /// <seealso cref="FlipControlActions.RemoveCallbacks(IFlipControlActions)" />
    public interface IFlipControlActions
    {
        /// <summary>
